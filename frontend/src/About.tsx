...
const About: React.FC = () => (
  <div>
    ...
    <p>
      ...
      across the musical spectrum. R&B, soul, gospel, pop, folk, rock, and jazz
      influences can all be heard in our repertoire. Besides singing, Effusion
      has been known for many a memorable skit at end-of-semester concerts and
      for questionable dance skills.
    </p>
    <p>
    ...
    <blockquote>
      <p><q>
        ...
        about this group caught me off guard&hellip; You know when a person goes
        into a zone, they get lost in their own little world? This was like
        watching a group of people get list in their own little &lsquo;group
        world&rsquo;
      </q></p>
    ...
    <blockquote>
      <p><q>
        It&apos;s astonishing how a group of 16 vocalists with pitches ranging
        from bass to soprano and everything in between are able to perform music
        live completely in time with one another.
      </q></p>
      <footer>Michael Gord [IX Daily]</footer>
    </blockquote>
  </div>
);
